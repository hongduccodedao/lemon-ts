...
const Navbar = () => {
  ...
  return (
    <div className="border-b border-ctp-overlay0 w-full bg-ctp-base">
      <div className="mx-auto max-w-[1200px] py-5 flex items-center justify-between px-2 lg:px-0">
        <div className="flex items-center gap-10 flex-1">
          ...
          >
            <span className="">{`🍋`}</span>
            <span className="hidden lg:block ">LeM0n c0d3</span>
          </Link>
          <div className="hidden lg:flex items-center border border-ctp-overlay0 rounded-md h-11 max-w-[400px] w-full">
            <input
              type="text"
